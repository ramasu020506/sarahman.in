...
const { sectionNumber, sectionLabel, subLabel, portrait, portraitAlt, caption, bio, quote: quoteData, skills: SKILLS, facts: FACTS } = siteData.about
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex items-end justify-between border-b border-border/70 pb-6">
          <div className="flex items-baseline gap-4">
            <span className="section-number text-2xl">{sectionNumber}</span>
          ...
          <div className="col-span-12 lg:col-span-7">
            ...
            <figure className="mt-12 border-l-2 border-emerald pl-6">
              ...
              <figcaption
                ...
                dangerouslySetInnerHTML={{ __html: quoteData.source }}
              />
            </figure>
